  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button 
          className="rounded-full px-6 font-medium text-sm bg-primary text-primary-foreground hover:bg-primary/90"
        >
          Sign up
        </Button>
      </DialogTrigger>
      <DialogContent className="border-slate-200 bg-white p-6 shadow-lg dark:border-slate-800 dark:bg-slate-900 sm:max-w-[400px]">
        <div className="flex flex-col items-center gap-2">
          ...
          <DialogHeader className="space-y-1">
            <DialogTitle className="text-2xl font-semibold text-slate-900 dark:text-white">Create an account</DialogTitle>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor={`${id}-name`} className="text-sm font-medium text-slate-900 dark:text-white">Full name</Label>
              <Input 
                id={`${id}-name`} 
          ...
          <p className="text-center text-xs text-slate-500 dark:text-slate-400">
            ...
            <a 
              className="text-slate-600 underline-offset-4 hover:text-oklch-21.6-0.006-56.043 hover:underline dark:text-slate-400" 
              href="#"
            >
              Terms of Service
            </a>
